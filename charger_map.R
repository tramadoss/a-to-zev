...
roads <- st_read(file.path("data/charging/Shape_file","shn2014v3_Segments.shp"))
Counties <- st_read(file.path("data/charging/CA_Counties","CA_Counties_TIGER2016.shp"))
Highways <- st_read(file.path("data/charging/SHN_Lines","HWY_SHN_Lines.shp"))
State_Boundary <- st_read(file.path("data/charging/ca-state-boundary","CA_State_TIGER2016.shp"))
Transmission <- st_read(file.path("data/charging/Transmission","Transmission_Line.shp"))
...
#Other attributes 
Substations <- st_read(file.path("data/charging/California_Electric_Substations","CA_Substations_Final.shp")) 
Substation_buffer <- st_buffer(Substations,4828.03)
Boundary <- st_read(file.path("data/charging/data-2","District_201511.shp"))
